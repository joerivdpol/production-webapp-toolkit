...
* API Contract Snapshot v1, provider-neutral compatibility comparator, and bounded OpenAPI JSON adapter: implementation complete on the active capability branch.
